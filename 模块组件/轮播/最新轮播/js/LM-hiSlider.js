    ...
    Slider.prototype = {
        ...
        setLayout: function(){
            ...
            if(this.options.isShowControls){
                this.$prev = $('<a href="javascript:;" class="hiSlider-btn-prev"><img src="images/prev-arrow.png"></a>');
                this.$next = $('<a href="javascript:;" class="hiSlider-btn-next"><img src="images/next-arrow.png"></a>');
