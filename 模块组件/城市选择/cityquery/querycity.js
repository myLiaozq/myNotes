...
;
        ...
        function resetPosition(){
            ...
            // console.log(input.position().right);
            // console.log(input.outerWidth());
            var cityBoxHeight1 = input.position().top+input.outerHeight();
            var cityBoxHeight2 = input.position().top+input.outerHeight();
            if(window.innerHeight-input.position().top<230){
                cityBoxHeight1 = input.position().top-204;
                cityBoxHeight2 = input.position().top-306;
            }
            popMain.css({'top':cityBoxHeight1,'left':input.position().left});
            suggestMain.css({'top':cityBoxHeight2,'left':input.position().left});
        }
    };
